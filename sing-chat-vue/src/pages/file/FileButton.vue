<template>
    <button class="Documents-btn" ref="button">
            ...
            <svg class="fileBack" width="146" height="113" viewBox="0 0 146 113" fill="none"
                ...
                <defs>
                    <linearGradient id="paint0_linear_117_4" x1="0" y1="0" x2="72.93" y2="95.4804"
                        ...
                        <stop offset="1" stop-color="#c8c9cc"></stop>
                    </linearGradient>
                </defs>
            </svg>
...
const props = defineProps(['content', 'type'])
const button = ref(null)
onMounted(() => {
    if (props.type == 'primary') {
        button.value.style.backgroundColor = "#a0cfff"
    } else if (props.type == 'danger') {
        button.value.style.backgroundColor = "#c8c9cc"
    } else {
        button.value.style.backgroundColor = "#A59ACA"
    }
})
